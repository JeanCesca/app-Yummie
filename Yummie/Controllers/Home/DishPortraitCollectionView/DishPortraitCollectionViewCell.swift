...
//            dishTitleLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -20)
            ...
            descriptionLabel.trailingAnchor.constraint(equalTo: dishImageView.trailingAnchor),
            descriptionLabel.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -10)
        ])
        
        dishTitleLabel.setContentHuggingPriority(.defaultHigh, for: .vertical)
        caloriesLabel.setContentHuggingPriority(.defaultHigh, for: .vertical)
    }
}
